  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/products/create" element={<RequireAuth><CreateProduct /></RequireAuth>} />
        ...
        <Route path="/promotions/create" element={<RequireAuth><CreatePromotion /></RequireAuth>} />
        <Route path="/promotions/:id" element={<RequireAuth><PromotionDetail /></RequireAuth>} />
        <Route path="/promotions/:id/edit" element={<RequireAuth><EditPromotion /></RequireAuth>} />
